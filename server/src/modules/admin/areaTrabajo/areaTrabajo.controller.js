import { AreaTrabajoServices as services } from './areaTrabajo.services.js';
...
export class AreaTrabajoController {
  static async getAll(req, res) {
    ...
    return res.status(200).json({
      ok: true,
      message: 'Areas de trabajo obtenidos correctamente',
      ...result,
    });
  }
  static async create(req, res) {
    ...
    return res.status(200).json({
      ok: true,
      message: 'Area de trabajo creado correctamente',
      data,
    });
  }
  static async update(req, res) {
    ...
    return res.status(200).json({
      ok: true,
      message: 'Area de trabajo actuzalizado correctamente',
      data,
    });
  }

...
//
import CargoInstitucionalModal from './CargoInstitucionalModal';
import { AreaTrabajoServices as Servs } from '../cargoInstitucional.services';
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <div className="flex flex-col gap-2">
            {tienePermiso('cargoInstitucional.editar') && (
              <button
                type="button"
    ...
    <>
      <div className="mb-6 flex items-center justify-between">
        <h2 className="text-xl font-semibold">
          GESTION DE CARGOS INSTITUCIONALES
        </h2>
        {tienePermiso('cargoInstitucional.crear') && (
          <button
            className="
            rounded-xl
            bg-emerald-800

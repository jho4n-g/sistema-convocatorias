...
//
import { AreaTrabajoServices as Servs } from '../cargoInstitucional.services.js';
import {
...
const camposMayuscula = ['nombre_cargo'];
...
export default function CargoInstitucionalModal({
  ...
  const handleValidation = () => {
    ...
    const result = isEdit
      ? cargoInstitucionalUpdateSchema.safeParse(payload)
      : cargoInstitucionalSchema.safeParse(payload);

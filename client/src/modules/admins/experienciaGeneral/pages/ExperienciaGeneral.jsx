...
//
import ExperienciaGeneralModal from './ExperienciaGeneralModal';
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <div className="flex flex-col gap-2">
            {tienePermiso('experienciaGeneral.editar') && (
              <button
                type="button"
  ...
  return (
    <>
      <div className="mb-6 flex items-center justify-between">
        ...
        {tienePermiso('experienciaGeneral.crear') && (
          <button
            className="
            rounded-xl
            bg-emerald-800

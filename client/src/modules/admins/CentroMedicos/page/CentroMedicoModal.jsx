...
import { centroMedicoSchema } from '../CentroMedico.schema';
...
export default function CentroMedicoModal({
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        if (isEdit) {
          const data = {
            nombre_centro: dataRow?.nombre_centro ?? '',
          };
  ...
  const handleValidation = () => {
    ...
    const result = centroMedicoSchema.safeParse(payload);

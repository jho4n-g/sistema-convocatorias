...
//
import { CentroMedicoServices as Servs } from '../CentroMedico.services';
import CentroMedicoModal from './CentroMedicoModal';
...

      {
        ...
        cell: ({ row }) => (
          <div className="flex flex-col gap-2">
            {tienePermiso('centroMedico.editar') && (
              <button
                type="button"
  ...
  return (
    <>
      <div className="mb-6 flex items-center justify-between">
        <h2 className="text-xl font-semibold">Gestion de Centros Medicos</h2>
        {tienePermiso('centroMedico.crear') && (
          <button
            className="
            rounded-xl
            bg-emerald-800

...
import { MisPostulacionesServices as Serv } from '../MisPostulaciones.services';
import DisplayField from '../../../../components/DisplayField';
import DataTableLocal from '../../../../components/DataTableLocal';

export default function MisPostulacionesModal({ open, id, onClose }) {
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      try {
        ...
        const response = await Serv.getConvocatoriaId(id);
          ...
          <div className="flex shrink-0 items-center justify-between border-b border-slate-200 px-6 py-4">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Información de la convocatoria y documentos presentados
              </p>
            </div>
          ...
          <div className="min-h-0 flex-1 overflow-y-auto p-6">
            ...
            <fieldset className="mb-8 rounded-xl border border-slate-200 p-5">
              ...
              <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
                <DisplayField label="TÍTULO" value={form?.titulo_cargo} />

                <DisplayField label="CARGO" value={form?.nombre_cargo} />
                ...
                <DisplayField label="ESTADO" value={form?.estado} />
            ...
            <fieldset className="mb-8 rounded-xl border border-slate-200 p-5">
              ...
              <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
                <DisplayField
                  ...
                  value={formPersona?.cedula_identidad}
                />

                <DisplayField label="NOMBRES" value={formPersona?.nombres} />
                ...
                <DisplayField
                  ...
                  value={formPersona?.fecha_nacimiento}
                />

                <DisplayField label="CORREO" value={formPersona?.correo} />

                <DisplayField
                  label="NUMERO CELULAR"
                  value={formPersona?.numero_celular}
                />

                <DisplayField
                  label="TRABAJO ANTERIORMENTE EN LA CAJA"
                  value={
                    formPersona?.trabajo_anteriormente_institucion ? 'SI' : 'NO'
                  }
                />
              </div>
            </fieldset>
